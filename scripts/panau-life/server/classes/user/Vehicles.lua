class("PanauVehicles")
  ...
  function PanauVehicles:SaveData(id)
    ...
    PanauLife.Database:execute([[
      UPDATE  vehicles
      SET     vehicle_posx = :posx, vehicle_posy = :posy, vehicle_posz = :posz, vehicle_colorr = :cr, vehicle_colorg = :cg, vehicle_colorb = :cb, vehicle_colorr2 = :cr2, vehicle_colorg2 = :cg2, vehicle_colorb2 = :cb2, vehicle_yaw = :yaw, vehicle_pitch = :pitch, vehicle_roll = :roll
